...
Quy trình bắt đầu khi người dùng chọn mua một dịch vụ trên hệ thống FitFuel+ như gói membership, combo dinh dưỡng, bundle hoặc gói gia hạn. Tại màn hình checkout, hệ thống hiển thị đầy đủ thông tin giỏ hàng gồm tên dịch vụ, giá, ưu đãi, số FitCoin có thể sử dụng và tổng tiền cần thanh toán. Người dùng có thể chỉnh sửa giỏ hàng ngay tại màn hình này bằng cách thêm món mới, xóa món, tăng/giảm số lượng hoặc thay đổi món trước khi xác nhận thanh toán.
...
Giỏ hàng phải hiển thị rõ từng thành phần: gói tập, sản phẩm dinh dưỡng, dịch vụ đi kèm, ưu đãi và tổng tiền cuối cùng. Người dùng được phép sửa giỏ hàng trước khi thanh toán, bao gồm thêm/xóa sản phẩm, đổi số lượng và thay thế món.
...
- *Nếu Có*: Nhân viên đề xuất giải pháp hỗ trợ (như hướng dẫn lại cách sử dụng thiết bị hoặc điều chỉnh hướng dẫn tập luyện) rồi hoàn tất task chăm sóc.
