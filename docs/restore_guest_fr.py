...
replacements = {
    ...
    # FR-058
    "Hệ thống cho phép Guest/Visitor xác thực bằng số điện thoại và OTP 6 số để đăng ký tài khoản trải nghiệm (Free Trial / Gym Tour); phiên khách có hiệu lực 2 giờ.":
    "Hệ thống cho phép Guest xác thực bằng số điện thoại và OTP 6 số để mua food/gear/supplement hoặc đăng ký Free Trial; session sau xác thực có hiệu lực 2 giờ.",
    
    "| FR-058 | Guest, Visitor |": "| FR-058 | Guest |",
...
print("Done restoring Guest purchasing permissions in Requirements.")
