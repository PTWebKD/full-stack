    ...
    <div className="space-y-4 max-w-4xl mx-auto">
      ...
      <div className="glass rounded-2xl border border-white/5 overflow-hidden">
        ...
        <div className="divide-y divide-white/5">
          {filtered.map(m => (
            <div key={m.id} className="grid grid-cols-12 px-5 py-3 items-center">
              ...
              <span className={`col-span-2 text-xs px-2 py-0.5 rounded-full w-fit capitalize ${m.plan === 'pro' ? 'bg-[#003a5a]/10 text-[#7dd3fc]' : 'bg-white/5 text-white/40'}`}>{m.plan}</span>
